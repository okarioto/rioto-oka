...
const badminton_club = {
    title: "Full Stack Developer", link: "https://github.com/Dom4489/UBCBC",
    bullets: [
        "Maintained and developed a full-stack web application using React, PostgreSQL, Express, HTML, CSS, and Tailwind, supporting 200 active users with a mobile-first, responsive design.",
        ...
        "Worked in an Agile environment, collaborating efficiently with non-technical executive team members"

    ],
    techs: ["JavaScript", "reactJS", "expressJS", "PostgreSQL", "Tailwind", "HTML", "CSS"]
}

const experience_list = [badminton_club, royal_nails]
