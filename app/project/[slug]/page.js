...
export default function ProjectPage() {
    ...
    const project = project_list[slug]
    ...
    useEffect(() => {
        async function callTypewriter() {
            ...
            await typewriter(desktopTitleRef, project.title, 200)
            await typewriter(mobileTitleRef, project.title, 200)
        }
        callTypewriter()
    ...
    return (
        <>
            <div className="hidden md:flex min-h-screen w-full  justify-center items-center mt-1 mb-1">
                <div className="flex flex-col items-center justify-evenly h-[95%]">
                    <div className="flex items-center justify-center">
                        <hr ref={desktopTitleLineRef} className=" w-0 h-[calc(0.4*10.5vw)] bg-thicksub  absolute right-0 -z-10 duration-1000" />
                        <h2 ref={desktopTitleRef} className="font-main text-[10.5vw] tracking-[calc(0.1*vw)] leading-none text-right uppercase text-nowrap after:content-['|'] after:animate-blink after:tracking-[0px] after:ml-[-2vw] after:mr-[-2vw]"></h2>
                    </div>
                    <div className="grid grid-cols-5 mt-24">
                        ...
                        <div className="col-span-2 flex flex-col items-center justify-between">
                            <div className="w-[80%]">
                                ...
                                <TechCard title="technologies" techs={project.techs} />
                            </div>
                            <div className="flex w-[90%] justify-between">
                                <Link className="font-main text-[4vw] tracking-[calc(0.5*4vw)] underline" href={"/#projects"}>BACK</Link>
                                <a className="font-main text-[4vw] tracking-[calc(0.5*4vw)] underline" href={project.link} target="_blank">VIEW</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="md:hidden flex min-h-screen w-full  justify-center items-center mt-1 mb-1">
                <div className="flex flex-col items-center justify-start h-[95vh] w-[90vw]">
                    <div className="w-full flex items-center justify-center">
                        ...
                        <h3 ref={mobileTitleRef} className="w-full text-nowrap font-main text-[9.5vw] tracking-[0] after:content-['|'] after:animate-blink text-center capitalize"></h3>
                    </div>
                    ...
                    <div className="flex w-full justify-between mt-4">
                        <Link className="font-main text-[10vw] tracking-[calc(0.5*4vw)] underline" href={"/#mobile-projects"}>BACK</Link>
                        <a className="font-main text-[10vw] tracking-[calc(0.5*4vw)] underline" href={project.link} target="_blank">VIEW</a>
                    </div>
