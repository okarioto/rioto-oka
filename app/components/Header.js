        ...
        <div>
            <header className="flex-wrapper min-h-[5rem] mt-[1rem]">
                <div className="flex  w-[80%] justify-between items-center flex-wrap md:flex-nowrap">
                    <a className="text-[14px] md:tracking-[0.7rem] order-2 md:order-none" href='https://github.com/okarioto' target="_blank">GITHUB</a>
                    ...
                    <a className="text-[14px] md:tracking-[0.7rem] order-3 md:order-none" href='mailto:okarioto@gmail.com' >EMAIL</a>
                </div>
