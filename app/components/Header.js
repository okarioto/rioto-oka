        ...
        <div>
            <header className="flex-wrapper min-h-[5rem] mt-[1rem]">
                <div className="flex  w-[80%] justify-between items-center flex-wrap md:flex-nowrap">
                    ...
                    <h1 className="md:text-[52px] text-[24px] font-bold tracking-[1rem] basis-full md:basis-auto flex justify-center"><a className="" href='https://www.linkedin.com/in/okarioto' target="_blank">RIOTO OKA</a></h1>
